...
@section('content')
<h2 class="text-center mb-5">Crear chollo</h2>
<div class="row col-md-12 justify-content-center ml-3 mr-3">
    <div class="card col-md-8 mt-2 mb-5">
        <div class="mt-3 mr-3 ml-3">
    <form method="POST" action="{{route('admin.chollos.store')}}" enctype="multipart/form-data" novalidate>
        @csrf
    ...
    <br>
        ...
        @enderror    
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Agregar chollo">
            </div>
        </form>
    </div>
    </div>

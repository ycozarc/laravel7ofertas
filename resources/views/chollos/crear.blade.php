...
@section('content')
<h2 class="text-center mb-5">Compartir chollo</h2>
<div class="row col-md-12 justify-content-center ml-3 mr-3">
    <div class="card col-md-12 mt-2 mb-5 shadow">
        <div class="mt-3 mr-3 ml-3">
    <form method="POST" action="{{route('chollos.store')}}" enctype="multipart/form-data" novalidate>
        @csrf
            ...
            <option value="{{$tienda->id}}" {{old('tienda') == $tienda->id ? 'selected' : ''}}>{{$tienda->nombre}}</option>
                    @endforeach
                </select>
                @error('tienda')
                <span class="invalid-feedback d-block" role="alert">
            ...
            <option value="{{$tipo->id}}" {{old('tipodescuento') == $tipo->id ? 'selected' : ''}}>{{$tipo->nombre}}</option>
                    @endforeach
                </select>
                @error('tipodescuento')
                <span class="invalid-feedback d-block" role="alert">
        ...
        <br>
            <div class="form-group" id="descuento" style="@if($errors->has('descuento')) display:block @else display:none @endif ;">
            ...
            <div class="form-group" id="precio_anterior" style="@if($errors->has('precio_anterior') || $errors->has('precio_actual')) display:block @else display:none @endif ;">
            ...
            <div class="form-group" id="precio_actual" style="@if($errors->has('precio_actual')) display:block @else display:none @endif ;" >
            ...
            <div class="form-group" id="gratis" style="@if($errors->has('gratis')) display:block @else display:none @endif ;">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Compartir chollo">
            </div>
        </form>
    </div>
</div>
